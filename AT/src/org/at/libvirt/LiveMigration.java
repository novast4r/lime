...
public class LiveMigration {
	...
	private final FlowsController fc = new FlowsController();
	...
	public LiveMigration(String vmname, String srcip, String dstip) {
		this.vmname = vmname;
		this.srcip  = srcip;
		this.dstip  = dstip;
	...
	public void migrate() {
		HostsSettings hs = new HostsSettings(); 
		Host src = hs.getHostByHostname(srcip);
		Host dst = hs.getHostByHostname(dstip);
